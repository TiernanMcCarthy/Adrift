...
#region Player spawn
        ...
        public void OnPlayerLeftShared(NetworkRunner runner, PlayerRef player)
        {
            PlayerDetails pd = PlayerManagement.instance.GetPlayerFromPlayerRef(player);
            if(pd!=null)
            {
                runner.Despawn(pd.GetComponent<NetworkObject>());
            }
        ...
        public void OnPlayerLeft(NetworkRunner runner, PlayerRef player) {
            ...
            {
                OnPlayerLeftShared(runner, player);
            }
            Debug.Log("YOOOOGOGOGOGO");
        }
#endregion
...
#region Unused INetworkRunnerCallbacks 
        ...
        {
            foreach(PlayerDetails d in PlayerManagement.instance.playerList)
            {
                d.ExecuteNonoBehaviours();
            }
           // if (PlayerManagement.instance.localPlayer != null)
            //{
             //   PlayerManagement.instance.localPlayer.MoveAndLookAtRPC(Vector3.zero, Vector3.forward);
            //}
